...
class PlanViewAPBoard(models.Model):
    _name = "planviewap.board"
    _description = "planviewap_board"
    ...
    type_board_ids = fields.Many2many(
        ...
        relation="type_board_ids_planviewap_board_rel",
        string="Type Board",
    )
    ...
    def action_sync(self):
        for rec in self:
            ...
            self.env["planviewap.card"].sync_pvap_cards(rec)
